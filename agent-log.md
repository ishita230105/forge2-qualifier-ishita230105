...
{
  "ok": true,
  "url": "https://taskflow-2dn1419.slack.com/",
  "team": "Taskflow",
  "user": "taskflow_bot",
  "team_id": "T0BC3NSRL3T",
  "user_id": "U0BBLE193L7",
...
```
Ishita Modi [3:15 PM]
@taskflow please plan the Laravel email notifications (using the log driver) for card assignment, and add a comment/activity log feature on React cards
```
